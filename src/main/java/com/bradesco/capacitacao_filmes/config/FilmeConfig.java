...
public class FilmeConfig implements CommandLineRunner{
	...
	public void run(String... args) throws Exception {
		...
		FilmeCadastroDTO filme1 = new FilmeCadastroDTO("Como treinar seu dragão", LocalDate.of(2020,02,19), 5, "Aventura", "Robert");
		FilmeCadastroDTO filme2 = new FilmeCadastroDTO("Velozes e furiosos", LocalDate.of(2018,03,19), 4, "Ação", "Autor um");
		FilmeCadastroDTO filme3 = new FilmeCadastroDTO("Superman", LocalDate.of(2023,02,8), 3, "Ação", "Autor dois");
		FilmeCadastroDTO filme4 = new FilmeCadastroDTO("Filme legal01", LocalDate.of(2000,04,16), 2, "Romance", "Autor um");
		FilmeCadastroDTO filme5 = new FilmeCadastroDTO("Filme Legal", LocalDate.of(2010,02,6), 1, "Comedia", "Robert");
		...
		repository.saveAll(Arrays.asList(filme21));
		repository.saveAll(Arrays.asList(filme22));
		repository.saveAll(Arrays.asList(filme23));
		repository.saveAll(Arrays.asList(filme24));
		repository.saveAll(Arrays.asList(filme25));
